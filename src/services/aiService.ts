...
const prompt = `قم بتحليل المحتوي التالي واستخرج منها بيانات العملاء والأجهزة.

كل سطر من النص يحتوي عادة على المعلومات التالية:
1. رقم تسلسلي واسم العميل والتاريخ والموقع
2. اسم المؤسسة (إن وجد)
3. العنوان
4. رقم الهاتف (يبدأ عادة بـ 01 أو 00966)
5. نوع النشاط التجاري
6. رقم تعريفي أو رمز تفعيل
...
- يكون بتنسيق XXXX-XXXX-XXXX (أربعة أرقام - أربعة أرقام - أربعة أرقام)
...
- يكون سلسلة من الأرقام (10-20 رقم) بدون شرطات
...
- إذا لم يُذكر نوع الاشتراك، لا تضع قيمة افتراضية واترك الحقل فارغًا
  ...
  "clients": [
    {
      ...
      "اسم المؤسسة": "اسم المؤسسة (إذا وجد، وإلا اترك فارغًا)",
...
- من غير الطبيعي أن يكون إجمالي عدد الأجهزة المستخرجة أقل من عدد العملاء المستخرجين
- تحقق مجددًا من مخرجاتك إذا كان عدد الأجهزة أقل من عدد العملاء
- لا تستخدم الأمثلة المذكورة كقيم فعلية في المخرجات
- لا تضيف قيم افتراضية إلا عند الضرورة القصوى
